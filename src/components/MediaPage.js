 ...
 class MediaPage extends React.Component {
  render() {
    ...
    <div style={{padding:15}}  ><text style={{fontSize:27 , fontWeight:'bold'}} >Be Social</text></div>
     ...
     <a href="https://www.facebook.com/MrToi-103532734467304" target="_blank"rel="noopener noreferrer" >  <FacebookIcon  style={{cursor:'pointer' ,width:40 , height:40 ,paddingRight:15 , color:'#3b5998'}} /></a>
      <a href="https://www.instagram.com/mrtoi_official/" target="_blank"rel="noopener noreferrer" > <InstagramIcon style={{cursor:'pointer',width:40 , height:40 ,paddingRight:15 , color:'#e4405f'}} /></a>
      <a href="https://www.linkedin.com/in/mr-toi-318193199" target="_blank" rel="noopener noreferrer"> <TwitterIcon style={{cursor:'pointer',width:40 , height:40 ,paddingRight:15, color:'#00acee'}} /></a>
      <a  href="https://twitter.com/MrToi10"  target="_blank" rel="noopener noreferrer"> <LinkedInIcon style={{cursor:'pointer',width:40 , height:40 ,paddingRight:15, color:'#0e76a8'}}  /></a>
    </div>
    </Grid>
    </Grid>
